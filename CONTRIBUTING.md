Contributing to exobot-adapter-slack
======================

So you want to contribute to exobot-adapter-slack? Fantastic! Here's a brief overview on
how best to do so.
...
[create an issue](https://github.com/exoplay/exobot-adapter-slack/issues) before putting
...
1. [Fork the repository](https://github.com/exoplay/exobot-adapter-slack/fork_select) to
  your Github account.
...
exobot-adapter-slack is MIT licensed. See details in the LICENSE file. This is a very permissive
